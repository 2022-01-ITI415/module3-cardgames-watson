...
public class GolfDeck : MonoBehaviour
{
	...
	public List<GolfCard>					cards;
	public List<Decor>				decorators;
	public List<CardDefinitions>			cardDefs;
